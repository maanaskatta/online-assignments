...
<body>
	...
	<div id="head" >
		...
		<p id="heading">PPL Assignment Page</p>
		<a id="logout" href="index.html">LOGOUT</a>
		<a id="links" href="PPLupload.php">UPLOAD</a>
		<a id="links" href="PPLseeAssign.php">ASSIGNMENTS</a>
	</div>
		

	<div id="upload">
		
		<form method="POST" enctype="multipart/form-data" action="PPLstorefile.php" >
