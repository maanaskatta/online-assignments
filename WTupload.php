...
<body>
	...
	<div id="head" >
		...
		<p id="heading">WT Assignment Page</p>
		<a id="logout" href="index.html">LOGOUT</a>
		<a id="links" href="WTupload.php">UPLOAD</a>
		<a id="links" href="WTseeAssign.php">ASSIGNMENTS</a>
	</div>
		

	<div id="upload">
		
		<form method="POST" enctype="multipart/form-data" action="WTstorefile.php" >
