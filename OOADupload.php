...
<body>
	...
	<div id="head" >
		...
		<p id="heading">OOAD Assignment Page</p>
		<a id="logout" href="index.html">LOGOUT</a>
		<a id="links" href="OOADupload.php">UPLOAD</a>
		<a id="links" href="OOADseeAssign.php">ASSIGNMENTS</a>
	</div>
		

	<div id="upload">
		
		<form method="POST" enctype="multipart/form-data" action="OOADstorefile.php" >
