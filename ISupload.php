...
<body>
	...
	<div id="head" >
		...
		<p id="heading">IS Assignment Page</p>
		<a id="logout" href="index.html">LOGOUT</a>
		<a id="links" href="ISupload.php">UPLOAD</a>
		<a id="links" href="ISseeAssign.php">ASSIGNMENTS</a>
	</div>
		

	<div id="upload">
		
		<form method="POST" enctype="multipart/form-data" action="ISstorefile.php" >
